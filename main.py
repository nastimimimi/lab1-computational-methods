# Модель: Автоматизоване складання розкладу занять кафедри — Генетичний алгоритм (5 семестр)
...
class GeneticScheduler:
    ...
    def run(self) -> List[Dict]:
        ...
        print(f"   Відхилення побажань:  {self._count_pref_deviation(best)}")
...
class ResultViewer:
    ...
    def plot_convergence(self):
        ...
        axes[0].set_title('Збіжність алгоритму', fontsize=15, fontweight='bold')
        ...
        print(" Збережено: convergence.png")
        plt.show()
    ...
    def plot_load(self, schedule: List[Dict]):
        ...
        plt.tight_layout()
        plt.savefig('load_distribution.png', dpi=150, bbox_inches='tight')
        print("📊 Збережено: load_distribution.png")
        plt.show()
    ...
    def print_report(self, schedule: List[Dict]):
        ...
        print(f"  Часових слотів: {self.data.slots_total}")
        print(f"\n   АЛГОРИТМ")
        print(f"  {'─'*40}")
